...
/// v0.8.5 B: 全量 CREATE TABLE 声明, 给老 DB <redacted>缺失的 2 张新表 (tool_global_stats / tool_session)
...
/// v0.8.5 B: 给老 DB <redacted>缺失的 tool_global_stats / tool_session 表 + 索引。幂等 (CREATE IF NOT EXISTS)。
