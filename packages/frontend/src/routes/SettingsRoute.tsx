  ...
  return (
    <div className="settings-page">
      ...
      <div className="settings-body">
        ...
        {/* v0.8.0: 数据库 — 同步状态 / 一键 Rebuild / Export/Import overrides */}
        <section>
          <h2>
            <Database size={16} /> 数据库 (observer.db)
          </h2>
          <DatabasePanel />
        </section>
      </div>
    ...
    <div className="db-panel" data-testid="db-panel">
      ...
      <div className="db-actions">
        ...
        <div className="import-group">
          ...
          <button onClick={() => handleImport("keepboth")} disabled={busy}>
            KeepBoth
          </button>
          <button onClick={() => handleImport("overwrite")} disabled={busy}>
            Overwrite
          </button>
