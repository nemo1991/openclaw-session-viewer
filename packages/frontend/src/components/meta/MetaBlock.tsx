...
// v0.9.18 (M2): 6 chart sub-component 抽到独立 file (charts/),通过 ChartBlock dispatcher 路由
...
export function MetaBlock({ block, label, parentJsonlPath }: MetaBlockProps) {
  ...
  switch (label) {
    ...
    // v0.9.18 (M2): 6 chart meta kind 通过 ChartBlock dispatcher 路由到独立 sub-component
