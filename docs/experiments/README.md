...
M3 TODO(切 Tauri 源 + 删 experiment/)见 [CHANGELOG.md](../../CHANGELOG.md) `[Unreleased].### 待办 (M3)` + 实施详情见 plan 文件 `$HOME/.claude/plans/openclaw-session-session-session-transient-kernighan.md`。
