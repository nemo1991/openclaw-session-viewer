...
(`$WORKSPACE/github/openclaw`,版本 `2026.5.14`) 与官方文档
...
```json
{"type":"session","version":3,"id":"883031bd-…","timestamp":"2026-06-23T07:24:38.552Z","cwd":"$HOME/.openclaw/workspace"}
...
```json
{
  ...
  "schemaVersion": 1,
  "sessionId": "883031bd-0634-4ce1-9756-bc2d9d9b1b3e",
  "runtimeFile": "$HOME/.openclaw/agents/main/sessions/883031bd-0634-4ce1-9756-bc2d9d9b1b3e.trajectory.jsonl"
}
```
...
```json
{
  "agent:main:main": {
    ...
    "sessionFile": "$HOME/.openclaw/agents/main/sessions/883031bd-….jsonl",
...
openclaw 仓库路径(本地):`$WORKSPACE/github/openclaw` (版本 `2026.5.14`)
